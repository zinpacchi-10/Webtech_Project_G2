...
// Fetch all bookings for today or pending check-in
$today = date("Y-m-d");
...
$sql = "SELECT b.booking_id, u.name AS guest_name, r.room_number, b.checkin_date, b.checkout_date
        ...
        WHERE b.checkin_date <= ? AND b.checkout_date >= ? AND b.booking_id NOT IN
        (SELECT booking_id FROM bookings WHERE checkin_date = ? AND notes='checked_in')";
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="../Control/checkinController.php" method="post">
